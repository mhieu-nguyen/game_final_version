...
export default class Robot11 {
    ...
    anims.create({
        key: 'robo11move',
        frames: anims.generateFrameNumbers('robo11', { start: 10, end: 16 }),
    ...
    update( robo11On, moving) {
        ...
        if ( robo11On == 1) {
            ...
            if (moving) {       // if still to R of this point, move L
                ...
                roboSprite4.anims.play('robo11move', true);
                ...
                roboSprite4.anims.play('robo11wait', true);
