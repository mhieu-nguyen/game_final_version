...
export default class GameScene extends Phaser.Scene {
    ...
    update() {
        ...
        if (this.last_asteroid != null &&
            ...
            (this.cache.trial - this.cache.player_trial == 1)) {
            this.cache.player_trial += 1;
        }
        
        if (this.cache.player_trial >= this.cache.n_trials) {
            this.nextPhase();
        }
    ...
    addData() {
        ...
        this.cache.data.trial_type.push('game');
        this.cache.data.player_y.push(this.ship.y);
        this.cache.data.hole1_y.push(this.hole);
        this.cache.data.hole2_y.push(this.hole2);
    ...
    updateAsteroids() {
        this.hole = this.cache.trial_info.positions_A[this.cache.trial];
        this.hole2 = this.cache.trial_info.positions_B[this.cache.trial];
