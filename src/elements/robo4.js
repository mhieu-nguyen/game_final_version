...
export default class Robot4 {
    ...
    anims.create({
        key: 'robo4move',
        frames: anims.generateFrameNumbers('robo4', { start: 10, end: 16 }),
    ...
    update(robo4On, moving) {
        ...
        if (robo4On == 1) {
            ...
            if (moving) {       // if still to R of this point, move L
                ...
                roboSprite4.anims.play('robo4move', true);
                ...
                roboSprite4.anims.play('robo4wait', true);
