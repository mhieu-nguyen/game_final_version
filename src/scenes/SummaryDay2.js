...
export default class SummaryPanel extends Phaser.Scene {
    ...
    create(){
        ...
        var chestsOpen = this.cache.task1_data.Chest_Open[(this.cache.trial_no-1)*4+1];
        lossRate = 0.20;
        if (chestsOpen<25){
        ...
        if (chestsOpen == 25){
            message = "You have finished exploring the desert!\n" +
            ...
            message = "You have decided to stop exploring the desert.\n" +
                      ...
                      "you have [b]2 more chances[/b] to collect the required amount.\n\n";
        }
        ...
        this.summary = this.rexUI.add.dialog({
            ...
            title: this.rexUI.add.label({
                ...
                text: this.add.text(0, 0, `After environment 2`, {fontSize: '24px'}),
                align: 'center',
                space: {
                    left: 15,
                    right: 15,
...
var transition = function(scene){
    ...
    scene.scene.start('Question_env2');
}
